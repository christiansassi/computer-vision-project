...
def blend_image(mat: cv2.typing.MatLike | cv2.cuda.GpuMat | cv2.UMat | list[cv2.typing.MatLike] | list[cv2.cuda.GpuMat] | list[cv2.UMat], intersection: int, offset: int = 20, intensity: int = 2) -> np.ndarray:
