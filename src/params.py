...
BOTTOM_VALUE = 0.4 # Value used for matching keypoints
...
REF_FRAME_TOP = 500 # Reference for top frame
REF_FRAME_BOTTOM = 500 # Reference for bottom frame
REF_FRAME_CENTER = 500 # Reference for center frame
